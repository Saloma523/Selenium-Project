...
public class WebOrderUtils {
   ...
   /* public static String returnOrderDate(WebDriver driver,String customerName){
    ...
    //this is the same method just in one line
    */
    ...
    public static void orderVerify(WebDriver driver,String customerName,String expectedOrderDte){

        String locator = "//td[.='"+customerName+"']/following-sibling::td[3]";
        WebElement customerDateCell = driver.findElement(By.xpath(locator));
        String actualOrderDate = customerDateCell.getText();
        Assert.assertTrue(actualOrderDate.equals(expectedOrderDte));
